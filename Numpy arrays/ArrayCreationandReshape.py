...
while True:
    ...
    if choice == '1':
        ...
        #Asking for number of variables and creating a matrix of variable n*n having value 5
        ...
        #Taking 2 lists as input,converting the list into array and concatenating them.
        ...
        #Printing 100 numbers between 0 and 1 with interval 0.01 and replacing the largest number with 99  
        ...
        #Replacing all odd numbers in an array with -1
        arr = np.arange(10)
